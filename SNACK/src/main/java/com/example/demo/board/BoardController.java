...
public class BoardController {
    ...
    @GetMapping("games")
    public ResponseEntity<Games[]> readGames() {
    ...
    public void memberDelete(@PathVariable Long boardId, @PathVariable Long memberId, Authentication authentication) throws BoardHostAuthenticationException {
        boardService.deleteMember(authentication, boardId, memberId);
    }
