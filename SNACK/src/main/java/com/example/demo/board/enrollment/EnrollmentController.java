...
public class EnrollmentController {
    ...
    public ResponseEntity readMemberRequest(Authentication authentication) {
        ...
        enrollmentService.readEnrollmentsByMember(memberId).iterator().forEachRemaining(
                enrollment -> {
    ...
    public ResponseEntity readRequest(Authentication authentication) {
        ...
        enrollmentService.readEnrollmentsByHost(hostId).iterator().forEachRemaining(
    ...
    public ResponseEntity acceptRequest(@PathVariable Long enrollmentId, @PathVariable Boolean flag, Authentication authentication)
            throws BoardSizeOverException, BoardMemberOverlappingException, BoardHostAuthenticationException, BoardHostAuthenticationException {
        String message;
