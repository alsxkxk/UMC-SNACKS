...
public class BoardService {
    ...
    @Autowired
    public BoardService(BoardRepository boardRepository, BoardSearchRepositoryImpl boardSearchRepositoryImpl, MemberRepository memberRepository, MemberService memberService, BoardMemberRepository boardMemberRepository, ChatService chatService) {
    ...
    public void deleteMember(Authentication authentication, Long boardId, Long memberId) throws BoardHostAuthenticationException {
        Board board = getBoard(boardId);
        Member member = memberService.findMemberById(String.valueOf(memberId));
        ...
        boardMembers.iterator().forEachRemaining(
                boardMember -> {
                    if (boardMember.getMember() == member){
    ...
    private void boardOwnerCheck(Board board, Authentication authentication) throws BoardHostAuthenticationException {
