...
public class MyInfoResponseDto {
    ...
    @Builder
    public MyInfoResponseDto(String myProfileImageUrl, String nickname, Long articleCount, Long followerCount, Long followCount, String introduction, List<MyInfoArticleResponseDto> myInfoArticleResponseDtoList,Long memberId) {
